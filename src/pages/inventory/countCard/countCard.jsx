    ...
    return (
        <div className='countcard flex gap-4'>
            <div className='self-center'>
                <div className={`logoContainer ${props.color === 'blue' ? 'blueCountLogoWrp' :
                        props.color === 'green' ? 'greenCountLogoWrp' :
                            props.color === 'yellow' ? 'yellowCountLogoWrp' :
                                props.color === 'pink' ? 'pinkCountLogoWrp' :
                                    props.color === 'black' ? 'blackCountLogoWrp' :
                                        props.color === 'orange' ? 'orangeCountLogoWrp' :
                                            props.color === 'red' ? 'redCountLogoWrp' :
                                                props.color === 'purple' ? 'purpleCountLogoWrp' :
                                                    props.color === 'teal' ? 'tealCountLogoWrp' :
                                                        props.color === 'indigo' ? 'indigoCountLogoWrp' :
                                                            props.color === 'cyan' ? 'cyanCountLogoWrp' :
                                                                'blueCountLogoWrp'
                    }`}>
                    {getImg(props.desc)}
                </div>
